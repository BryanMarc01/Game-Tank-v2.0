...
public class CameraControl : MonoBehaviour
{
 ...
 int numTargets = 0;
 //Recorre la cantidad de tanques activos, captura su posición y asigna m_DesiredPosition el punto medio entre ellos (en el eje Y)
 ...
 //escojo el máximo entre el tamaño de cámara actual y la distanciadel tanque (arriba o abajo)
