...
public GameObject m_ExplosionPrefab; //Prefab que instanciamos alinicio y usamos cuando el tanque se muere
 ...
 m_ExplosionAudio =
m_ExplosionParticles.GetComponent<AudioSource>();
...
m_Slider.value = m_CurrentHealth;
 ...
 {
 // Configuro el booleano a true para asegurarme de que explota solouna vez.
m_Dead = true;

 // Coloco el prefab de explosión en la posición actual del tanque ylo activo.
