...
{
 public int m_NumRoundsToWin = 7; //Número de rondas que un jugador debe ganar para ganar el juego
 ...
 if (m_GameWinner != null)
 message = m_GameWinner.m_ColoredPlayerText + " GANA EL JUEGO!  " + m_RoundWinner.m_Wins + "  Kills Obtenidos";;
